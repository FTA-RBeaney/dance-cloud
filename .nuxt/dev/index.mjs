...
import { renderToString } from 'file:///Users/robertbeaney/Web%20Sites/dance-cloud/node_modules/.pnpm/vue@3.4.34_typescript@5.5.2/node_modules/vue/server-renderer/index.mjs';
...
import { propsToString, renderSSRHead } from 'file:///Users/robertbeaney/Web%20Sites/dance-cloud/node_modules/.pnpm/@unhead+ssr@1.9.16/node_modules/@unhead/ssr/dist/index.mjs';
...
import { isVNode, version, unref } from 'file:///Users/robertbeaney/Web%20Sites/dance-cloud/node_modules/.pnpm/vue@3.4.34_typescript@5.5.2/node_modules/vue/index.mjs';
...
import BaseStyle from 'file:///Users/robertbeaney/Web%20Sites/dance-cloud/node_modules/.pnpm/@primevue+core@4.0.4_vue@3.4.34_typescript@5.5.2_/node_modules/@primevue/core/base/style/index.mjs';
...
import { defineHeadPlugin } from 'file:///Users/robertbeaney/Web%20Sites/dance-cloud/node_modules/.pnpm/@unhead+shared@1.9.16/node_modules/@unhead/shared/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "hub": {
    ...
    "projectKey": "dancecloud-3gb5",
    "userToken": "user_vyWwUku1UmNkvfxhQeCE2E9Fg9Akaz",
    "remote": "",
    "remoteManifest": "",
    "dir": ".data/hub",
    "ai": false,
  ...
  "wrangler": {
    ...
    "persistDir": "/Users/robertbeaney/Web Sites/dance-cloud/.data/hub"
  }
};
const envOptions = {
  prefix: "NITRO_",
...
const serverAssets = [{"baseName":"server","dir":"/Users/robertbeaney/Web Sites/dance-cloud/server/assets"}];
...
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/robertbeaney/Web Sites/dance-cloud/.data/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"/Users/robertbeaney/Web Sites/dance-cloud/content","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/robertbeaney/Web Sites/dance-cloud/.nuxt/content-cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/robertbeaney/Web Sites/dance-cloud","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/robertbeaney/Web Sites/dance-cloud/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/robertbeaney/Web Sites/dance-cloud/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/robertbeaney/Web Sites/dance-cloud/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _D9HFvlvz9z = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/robertbeaney/Web Sites/dance-cloud";
...
function proxyHubDatabase(projectUrl, secretKey) {
  ...
  return {
    ...
    async dump() {
      return d1API("/dump").catch(handleProxyError$1);
    },
    prepare(query) {
      const stmt = {
        _body: {
...
const _Plk9L5HVA6 = defineNitroPlugin$1(async () => {
...
const _pNx9pdDUKK = defineNitroPlugin$1(async (nitro) => {
...
const _8w3RsEJay0 = defineNitroPlugin(async (nitroApp) => {
...
async function _getPlatformProxy() {
  ...
  if (runtimeConfig.wrangler.shamefullyPatchR2Buckets) {
    const { patchR2Bucket } = await Promise.resolve().then(function () { return r2Patch; });
...
const _Y01CXN = eventHandler(async (event) => {
  const { pathname } = parseURL(event.path);
  const redirects = await hubKV().get("redirects");
  if (redirects == null ? void 0 : redirects[pathname]) {
    return sendRedirect(event, redirects[pathname]);
  }
});

const _Ykb3yU = eventHandler((event) => {
  handleCors(event, {
    methods: "*",
    origin: [
...
const _ye3x20 = defineEventHandler(async (event) => {
...
const _ldwY02 = defineEventHandler(async (event) => {
...
const _snRBWL = defineEventHandler(async (event) => {
  const query = getContentQuery(event);
...
const _gGTmeA = eventHandler((event) => {
...
const openapi = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: _gGTmeA
});

const _JxEq2m = eventHandler((event) => {
...
const _a3haAa = eventHandler((event) => {
...
const _lazy_HhBJqK = () => Promise.resolve().then(function () { return upload_post$1; });
const _lazy_bjz8Cm = () => Promise.resolve().then(function () { return index_get$7; });
const _lazy_6tk7KC = () => Promise.resolve().then(function () { return index_post$3; });
...
const _lazy_7KPpcb = () => Promise.resolve().then(function () { return ____feature_$1; });
const _lazy_EDd8OT = () => Promise.resolve().then(function () { return index_head$1; });
const _lazy_N0VaYk = () => Promise.resolve().then(function () { return manifest_get$1; });
const _lazy_6LMEiY = () => Promise.resolve().then(function () { return openapi_get$1; });
const _lazy_VvKyjN = () => Promise.resolve().then(function () { return ____pathname__delete$1; });
const _lazy_zIiIQk = () => Promise.resolve().then(function () { return ____pathname__get$3; });
const _lazy_yJzZDO = () => Promise.resolve().then(function () { return ____pathname__put$1; });
const _lazy_mWna6k = () => Promise.resolve().then(function () { return deleteFolder_post$1; });
const _lazy_yqdBHE = () => Promise.resolve().then(function () { return delete_post$1; });
const _lazy_1itNrw = () => Promise.resolve().then(function () { return ____pathname__get$1; });
const _lazy_QIXL1y = () => Promise.resolve().then(function () { return index_get$3; });
const _lazy_v8EDBj = () => Promise.resolve().then(function () { return index_post$1; });
const _lazy_qa76qX = () => Promise.resolve().then(function () { return ____pathname_$1; });
const _lazy_kKgFBn = () => Promise.resolve().then(function () { return ____key__delete$1; });
const _lazy_oWkFJK = () => Promise.resolve().then(function () { return ____key__get$1; });
const _lazy_o0t97w = () => Promise.resolve().then(function () { return ____key__options$1; });
const _lazy_HAZVW1 = () => Promise.resolve().then(function () { return batchDelete_options$1; });
const _lazy_ayLAED = () => Promise.resolve().then(function () { return batchDelete_post$1; });
const _lazy_qQo3vp = () => Promise.resolve().then(function () { return ____base__delete$1; });
const _lazy_DUozWb = () => Promise.resolve().then(function () { return ____base__options$1; });
const _lazy_M7XVuz = () => Promise.resolve().then(function () { return index_get$1; });
const _lazy_36ODgV = () => Promise.resolve().then(function () { return _command__post$1; });
const _lazy_B3xcKU = () => Promise.resolve().then(function () { return query_options$1; });
const _lazy_vCD0pS = () => Promise.resolve().then(function () { return query_post$1; });
const _lazy_UZY4x7 = () => Promise.resolve().then(function () { return ____path_$1; });
const _lazy_7WM2tt = () => Promise.resolve().then(function () { return _pathname__get$1; });
const _lazy_2sUbF3 = () => Promise.resolve().then(function () { return renderer$1; });
...
const handlers = [
  ...
  { route: '/api/images/upload', handler: _lazy_HhBJqK, lazy: true, middleware: false, method: "post" },
  { route: '/api/messages', handler: _lazy_bjz8Cm, lazy: true, middleware: false, method: "get" },
  { route: '/api/messages', handler: _lazy_6tk7KC, lazy: true, middleware: false, method: "post" },
  ...
  { route: '/api/_hub/**:feature', handler: _lazy_7KPpcb, lazy: true, middleware: false, method: undefined },
  { route: '/api/_hub', handler: _lazy_EDd8OT, lazy: true, middleware: false, method: "head" },
  { route: '/api/_hub/manifest', handler: _lazy_N0VaYk, lazy: true, middleware: false, method: "get" },
  { route: '/api/_hub/openapi', handler: _lazy_6LMEiY, lazy: true, middleware: false, method: "get" },
  { route: '/api/_hub/blob/**:pathname', handler: _lazy_VvKyjN, lazy: true, middleware: false, method: "delete" },
  { route: '/api/_hub/blob/**:pathname', handler: _lazy_zIiIQk, lazy: true, middleware: false, method: "get" },
  { route: '/api/_hub/blob/**:pathname', handler: _lazy_yJzZDO, lazy: true, middleware: false, method: "put" },
  { route: '/api/_hub/blob/delete-folder', handler: _lazy_mWna6k, lazy: true, middleware: false, method: "post" },
  { route: '/api/_hub/blob/delete', handler: _lazy_yqdBHE, lazy: true, middleware: false, method: "post" },
  { route: '/api/_hub/blob/head/**:pathname', handler: _lazy_1itNrw, lazy: true, middleware: false, method: "get" },
  { route: '/api/_hub/blob', handler: _lazy_QIXL1y, lazy: true, middleware: false, method: "get" },
  { route: '/api/_hub/blob', handler: _lazy_v8EDBj, lazy: true, middleware: false, method: "post" },
  { route: '/api/_hub/blob/multipart/:action/**:pathname', handler: _lazy_qa76qX, lazy: true, middleware: false, method: undefined },
  { route: '/api/_hub/cache/**:key', handler: _lazy_kKgFBn, lazy: true, middleware: false, method: "delete" },
  { route: '/api/_hub/cache/**:key', handler: _lazy_oWkFJK, lazy: true, middleware: false, method: "get" },
  { route: '/api/_hub/cache/**:key', handler: _lazy_o0t97w, lazy: true, middleware: false, method: "options" },
  { route: '/api/_hub/cache/batch-delete', handler: _lazy_HAZVW1, lazy: true, middleware: false, method: "options" },
  { route: '/api/_hub/cache/batch-delete', handler: _lazy_ayLAED, lazy: true, middleware: false, method: "post" },
  { route: '/api/_hub/cache/clear/**:base', handler: _lazy_qQo3vp, lazy: true, middleware: false, method: "delete" },
  { route: '/api/_hub/cache/clear/**:base', handler: _lazy_DUozWb, lazy: true, middleware: false, method: "options" },
  { route: '/api/_hub/cache', handler: _lazy_M7XVuz, lazy: true, middleware: false, method: "get" },
  { route: '/api/_hub/database/:command', handler: _lazy_36ODgV, lazy: true, middleware: false, method: "post" },
  { route: '/api/_hub/database/query', handler: _lazy_B3xcKU, lazy: true, middleware: false, method: "options" },
  { route: '/api/_hub/database/query', handler: _lazy_vCD0pS, lazy: true, middleware: false, method: "post" },
  { route: '/api/_hub/kv/**:path', handler: _lazy_UZY4x7, lazy: true, middleware: false, method: undefined },
  { route: '/images/:pathname', handler: _lazy_7WM2tt, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_2sUbF3, lazy: true, middleware: false, method: undefined },
  { route: '/api/_hub', handler: _Ykb3yU, lazy: false, middleware: true, method: undefined },
  { route: '/api/_content/query/:qid/**:params', handler: _ye3x20, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _ye3x20, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _ye3x20, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.json', handler: _ldwY02, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _snRBWL, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _snRBWL, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _snRBWL, lazy: false, middleware: false, method: "get" },
  ...
  { route: '/_scripts/**', handler: _lazy_2sUbF3, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_2sUbF3, lazy: true, middleware: false, method: undefined }
];
...
const handlersMeta = [
  ...
  {
    "route": "/api/_hub/manifest",
    "method": "get"
  },
  {
    "route": "/api/_hub/openapi",
    "method": "get"
  },
  {
    "route": "/api/_hub/blob/**:pathname",
    "method": "delete"
  },
  {
    "route": "/api/_hub/blob/**:pathname",
  ...
  {
    "route": "/api/_hub/blob/delete-folder",
    "method": "post"
  },
  {
    "route": "/api/_hub/blob/delete",
    "method": "post"
  },
  {
    "route": "/api/_hub/blob/head/**:pathname",
    "method": "get"
  },
  {
    "route": "/api/_hub/blob",
  ...
  {
    "route": "/api/_hub/blob/multipart/:action/**:pathname"
  },
  {
    "route": "/api/_hub/cache/**:key",
    "method": "delete"
  },
  {
    "route": "/api/_hub/cache/**:key",
  ...
  {
    "route": "/api/_hub/cache/batch-delete",
    "method": "options"
  },
  {
    "route": "/api/_hub/cache/batch-delete",
  ...
  {
    "route": "/api/_hub/cache/clear/**:base",
    "method": "delete"
  },
  {
    "route": "/api/_hub/cache/clear/**:base",
  ...
  {
    "route": "/api/_hub/cache",
    "method": "get"
  },
  {
    "route": "/api/_hub/database/:command",
    "method": "post"
  },
  {
    "route": "/api/_hub/database/query",
    "method": "options"
  },
  {
    "route": "/api/_hub/database/query",
  ...
  {
    "route": "/api/_hub/kv/**:path"
  },
  {
    "route": "/images/:pathname",
    "method": "get"
  },
  {
    "route": "/__nuxt_error"
...
const r2Patch = /*#__PURE__*/Object.freeze({
  __proto__: null,
  patchR2Bucket: patchR2Bucket
});
...
const cached_get$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: cached_get
});
...
const _pathname__delete$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: _pathname__delete
});

const index_get$8 = eventHandler(async () => {
...
const index_get$6 = eventHandler(async () => {
...
const index_post$2 = eventHandler(async (event) => {
  ...
  const db = hubDatabase();
  await db.prepare("INSERT INTO messages (text, created_at) VALUES (?1, ?2)").bind(text, Date.now()).run();
  return {};
});
...
const openapi_get = eventHandler(async (event) => {
  ...
  const openapi$1 = await Promise.resolve().then(function () { return openapi; }).then((mod) => mod.default).catch(() => void 0);
  if (typeof openapi$1 !== "function") {
    throw createError({
      statusCode: 404,
      message: "not found"
    });
  }
  return openapi$1(event);
});
...
const ____pathname__delete = eventHandler(async (event) => {
  await requireNuxtHubAuthorization();
  requireNuxtHubFeature("blob");
  const { pathname } = await getValidatedRouterParams(event, z.object({
    pathname: z.string().min(1)
...
const ____pathname__delete$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: ____pathname__delete
});

const ____pathname__get$2 = eventHandler(async (event) => {
  await requireNuxtHubAuthorization();
  requireNuxtHubFeature("blob");
  const { pathname } = await getValidatedRouterParams(event, z.object({
    pathname: z.string().min(1)
...
const ____pathname__get$3 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: ____pathname__get$2
});

const ____pathname__put = eventHandler(async (event) => {
  await requireNuxtHubAuthorization();
  requireNuxtHubFeature("blob");
  const { pathname } = await getValidatedRouterParams(event, z.object({
    pathname: z.string().min(1)
...
const ____pathname__put$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: ____pathname__put
});

const deleteFolder_post = eventHandler(async (event) => {
  await requireNuxtHubAuthorization();
  requireNuxtHubFeature("blob");
...
const deleteFolder_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: deleteFolder_post
});

const delete_post = eventHandler(async (event) => {
  await requireNuxtHubAuthorization();
  requireNuxtHubFeature("blob");
...
const ____pathname__get$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
...
const index_post = eventHandler(async (event) => {
  ...
  return hubBlob().handleUpload(event, {
    ...
    put: destr$1(query.put),
    ensure: destr$1(query.ensure)
  });
});
...
const ____pathname_ = eventHandler(async (event) => {
  await requireNuxtHubAuthorization();
  requireNuxtHubFeature("blob");
  const query = getQuery$1(event);
...
const ____pathname_$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: ____pathname_
});
...
const statementValidation$1 = z.object({
...
const _command__post = eventHandler(async (event) => {
  ...
  if (command === "batch") {
    const statements = await readValidatedBody(event, z.array(statementValidation$1).parse);
    return db.batch(
...
const query_options$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
...
const query_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: query_post
});

const ____path_ = eventHandler(async (event) => {
  await requireNuxtHubAuthorization();
  requireNuxtHubFeature("kv");
  const storage = hubKV();
...
const _pathname__get$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: _pathname__get
});
...
const getClientManifest = () => import('file:///Users/robertbeaney/Web%20Sites/dance-cloud/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/robertbeaney/Web%20Sites/dance-cloud/.nuxt/dist/server/server.mjs').then((r) => r.default || r);

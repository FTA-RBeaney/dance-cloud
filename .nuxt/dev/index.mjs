...
const _lazy_XGUe3y = () => Promise.resolve().then(function () { return notionBlocks$1; });
const _lazy_8iP9Oi = () => Promise.resolve().then(function () { return notionPageRetrieve$1; });
const _lazy_k4kzHP = () => Promise.resolve().then(function () { return notionPage$1; });
...
const handlers = [
  ...
  { route: '/api/notion-blocks', handler: _lazy_XGUe3y, lazy: true, middleware: false, method: undefined },
  { route: '/api/notion-page-retrieve', handler: _lazy_8iP9Oi, lazy: true, middleware: false, method: undefined },
  { route: '/api/notion-page', handler: _lazy_k4kzHP, lazy: true, middleware: false, method: undefined },
...
const handlersMeta = [
  ...
  {
    "route": "/api/notion-blocks"
  },
  {
    "route": "/api/notion-page-retrieve"
  },
  {
    "route": "/api/notion-page"
  },
  {
    "route": "/api/notion"
  },
...
const notion$5 = new Client({ auth: process.env.NOTION_API_KEY });
const notionBlocks = defineEventHandler(async (event) => {
  const data = await readBody(event);
  const body = await notion$5.blocks.children.list({
    block_id: data.id
  });
  return { body };
});

const notionBlocks$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: notionBlocks
});

const notion$4 = new Client({ auth: process.env.NOTION_API_KEY });
const notionPageRetrieve = defineEventHandler(async (event) => {
  const data = await readBody(event);
  const response = await notion$4.pages.retrieve({ page_id: data.id });
  return { response };
});

const notionPageRetrieve$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: notionPageRetrieve
});

const notion$3 = new Client({ auth: process.env.NOTION_API_KEY });
const notionPage = defineEventHandler(async (event) => {
  const data = await readBody(event);
  const body = await notion$3.databases.query({
    database_id: data.id,
    sorts: [
      {
        property: "Order",
...
const notionPage$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: notionPage
});
...
const notion$1 = defineEventHandler(() => payload.results);

const notion$2 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: notion$1
});

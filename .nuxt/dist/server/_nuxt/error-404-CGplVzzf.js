import { v as vueExports, u as useRouter, p as parseQuery, n as nuxtLinkDefaults, h as hasProtocol, r as resolveRouteObject, j as joinURL, a as navigateTo, b as useRuntimeConfig, w as withTrailingSlash, c as withoutTrailingSlash, d as useHead, s as ssrRenderAttrs_1, e as ssrInterpolate_1, f as ssrRenderComponent_1 } from "../server.mjs";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs_1(vueExports.mergeProps({ class: "font-sans antialiased bg-white dark:bg-black text-black dark:text-white grid min-h-screen place-content-center overflow-hidden" }, _attrs))} data-v-44fb032f><div class="fixed left-0 right-0 spotlight z-10" data-v-44fb032f></div><div class="max-w-520px text-center z-20" data-v-44fb032f><h1 class="text-8xl sm:text-10xl font-medium mb-8" data-v-44fb032f>${ssrInterpolate_1(__props.statusCode)}</h1><p class="text-xl px-8 sm:px-0 sm:text-4xl font-light mb-16 leading-tight" data-v-44fb032f>${ssrInterpolate_1(__props.description)}</p><div class="w-full flex items-center justify-center" data-v-44fb032f>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@3.12.4_@opentelemetry+api@1.9.0_@parcel+watcher@2.4.1_@types+node@20.14.9_encoding@0.1.1_cu6mymf3lhirgq43i47sptbq2u/node_modules/nuxt/dist/app/components/error-404.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-44fb032f"]]);
export {
  error404 as default
};
//# sourceMappingURL=error-404-CGplVzzf.js.map

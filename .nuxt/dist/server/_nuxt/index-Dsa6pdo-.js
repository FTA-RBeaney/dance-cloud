import { g as useNuxtApp, i as asyncDataDefaults, v as vueExports, k as createError, l as fetchDefaults, s as ssrRenderAttrs_1, m as ssrRenderList_1, o as ssrRenderAttr_1, q as ssrRenderStyle_1, e as ssrInterpolate_1, f as ssrRenderComponent_1 } from "../server.mjs";
...
const _sfc_main$2 = /* @__PURE__ */ vueExports.defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs_1(_attrs)}><h3>Server redirects</h3><form><p><textarea rows="6" placeholder="/from /to (one redirect per line)" style="${ssrRenderStyle_1({ "width": "300px" })}">${ssrInterpolate_1(vueExports.unref(redirects).text)}</textarea></p><button type="submit"> Save redirects </button></form></div>`);
    };
  }
});
...
//# sourceMappingURL=index-Dsa6pdo-.js.map

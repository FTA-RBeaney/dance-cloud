    ...
    <main id="profile-form">
      ...
      >
        <div class="mb-4 col-span-full xl:mb-2">
          <h1
            class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white mb-0 mt-6"
          >
            User settings
          </h1>
        </div>
          ...
          >
            ...
            >
              <img
                ...
                alt="Jese picture"
                src="https://lh3.googleusercontent.com/a/ACg8ocJPJG2lKugFYNE_AqUNgxT0fR9SJ0aTd3xtQc4jxizLubbmo-id=s96-c"
              />
              <div>
                <h3
          ...
          >
            <div class="flow-root">
              ...
              <ul class="mb-6 divide-y divide-gray-200 dark:divide-gray-700">
                <!-- <li v-for="(user, i) in users" :key="`user${i}`" class="py-4">
                    <div
      ...
      <div class="grid grid-cols-1 px-4 xl:grid-cols-2 xl:gap-4">
        ...
        >
          <div class="flow-root">
            ...
            <p>No favourites added yet. Come back when you've added some!</p>
          </div>
        </div>
        <div
          class="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800 xl:mb-0"
        >
          <div class="flow-root">
            <h3 class="text-xl font-semibold dark:text-white">Your comments</h3>
            <div class="mt-4">
              <ul>
                <!-- <li v-for="(post, i) in posts" :key="`comment${i}`">
                    <article class="mb-5">
                      <footer class="flex items-center justify-between mb-2">
                        ...
                        <div
                          ...
                          style="
                            ...
                            margin: 0px;
                            transform: translate3d(869.5px, 1286px, 0px);
                          "
